(function(){
    ...
    function managedata(){
        ...
        var items=[
        {name:"apple",quantity:6,m:"",price:20},
        {name:"banana",quantity:15,m:"",price:12},
        {name:"orange",quantity:7,m:"",price:20},
        {name:"sapota",quantity:6,m:"",price:12},
        {name:"carrots",quantity:6,m:"",price:14.50},
        {name:"onions",quantity:5,m:"",price:25},
        {name:"potato",quantity:7,m:"",price:17}
                          ];
        var itemscompleted=[];
        ...
        service.boughtitem=function(index){
            ...
            var my={name:x,quantity:1,price:p};
